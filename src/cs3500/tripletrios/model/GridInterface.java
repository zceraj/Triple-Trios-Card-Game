...
public interface GridInterface {
   ...
   */
  CellInterface getCell(int row, int col) throws IndexOutOfBoundsException;
   ...
   */
  CellInterface getAdjacentCells(
          int row,
          int col,
   ...
   */
  void updateCell(int row, int col, CellInterface newCell);
